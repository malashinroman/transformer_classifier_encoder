...
def get_classifier(args, classifier, pretrained, features=False):
    if classifier == "vgg11_bn":
        ...
        if features:
            return resnet18(args, pretrained=pretrained, features=features)
        else:
            return resnet18(args, pretrained=pretrained)
